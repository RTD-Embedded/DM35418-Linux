...
int DM35418_Gbc_Board_Reset(struct DM35418_Board_Descriptor *handle)
{
	...
	ioctl_request.readwrite.access.data.data8 = DM35418_BOARD_RESET_VALUE;
	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_BOARD_RESET;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;

	return_value = DM35418_Write(handle, &ioctl_request);
	...
	if (return_value == 0) {
		 ...
		 */
		DM35418_Micro_Sleep(DM35418_RESET_DELAY_MICRO_SEC);
	}
...
DM35418LIB_API
int DM35418_Gbc_Ack_Interrupt(struct DM35418_Board_Descriptor *handle)
{
	union dm35418_ioctl_argument ioctl_request;

	ioctl_request.readwrite.access.data.data8 = DM35418_BOARD_ACK_INTERRUPT;
	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_END_INTERRUPT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
...
DM35418LIB_API
int DM35418_Gbc_Get_Format(struct DM35418_Board_Descriptor *handle,
				uint8_t *format_id)
{
	union dm35418_ioctl_argument ioctl_request;
	int return_code;

	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_FORMAT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
...
DM35418LIB_API
int DM35418_Gbc_Get_Revision(struct DM35418_Board_Descriptor *handle,
				uint8_t *rev)
{
	union dm35418_ioctl_argument ioctl_request;
	int return_code;

	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_REV;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	return_code = DM35418_Read(handle, &ioctl_request);
...
DM35418LIB_API
int DM35418_Gbc_Get_Pdp_Number(struct DM35418_Board_Descriptor *handle,
				uint32_t *pdp_num)
{
	union dm35418_ioctl_argument ioctl_request;
	int return_code;

	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_PDP_NUMBER;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
...
DM35418LIB_API
int DM35418_Gbc_Get_Fpga_Build(struct DM35418_Board_Descriptor *handle,
				uint32_t *fpga_build)
{
	union dm35418_ioctl_argument ioctl_request;
	int return_code;

	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_FPGA_BUILD;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
	return_code = DM35418_Read(handle, &ioctl_request);
...
DM35418LIB_API
int DM35418_Gbc_Get_Sys_Clock_Freq(struct DM35418_Board_Descriptor *handle,
				uint32_t *clock_freq, int *is_std_clk)
{
	...
	ioctl_request.readwrite.access.offset = DM35418_OFFSET_GBC_SYS_CLK_FREQ;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
...
DM35418LIB_API
int DM35418_Function_Block_Open(struct DM35418_Board_Descriptor *handle,
				unsigned int number,
				struct DM35418_Function_Block *func_block)
{
	...
	if (number >= DM35418_MAX_FB) {
		return -1;
	}

	fb_offset_in_gbc = DM35418_OFFSET_GBC_FB_START +
				(number * DM35418_GBC_FB_BLK_SIZE) +
				DM35418_OFFSET_GBC_FB_ID;
	...
	func_block->type = id_value & DM35418_FB_ID_TYPE_MASK;
	func_block->sub_type = (id_value & DM35418_FB_ID_SUBTYPE_MASK) >> 16;
	func_block->type_revision = (id_value & DM35418_FB_ID_TYPE_REV_MASK) >> 24;
	...
	if (func_block->type == DM35418_FUNC_BLOCK_INVALID ||
	    func_block->type == DM35418_FUNC_BLOCK_INVALID2) {
		return 0;
	}

	ioctl_request.readwrite.access.offset = fb_offset_in_gbc + DM35418_OFFSET_GBC_FB_OFFSET;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
	 ...
	 */
	ioctl_request.readwrite.access.offset = fb_offset_in_gbc + DM35418_OFFSET_GBC_FB_DMA_OFFSET;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_GBC;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
	...
	if ((ioctl_request.readwrite.access.data.data32 & DM35418_FB_ID_TYPE_MASK) != func_block->type) {
		errno = EFAULT;
		return -1;
	}

	ioctl_request.readwrite.access.offset = func_block->fb_offset + DM35418_OFFSET_FB_DMA_CHANNELS;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	...
	ioctl_request.readwrite.access.offset = func_block->fb_offset + DM35418_OFFSET_FB_DMA_BUFFERS;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	...
	func_block->control_offset = func_block->fb_offset + DM35418_OFFSET_FB_CTRL_START;

	for (chan = 0; chan < func_block->num_dma_channels; chan ++) {

		func_block->dma_channel[chan].control_offset = func_block->dma_offset +
				(DM35418_DMA_CTRL_BLOCK_SIZE +
				(DM35418_DMA_BUFFER_CTRL_BLOCK_SIZE * func_block->num_dma_buffers)) * chan;
		...
		for (buff = 0; buff < func_block->num_dma_buffers; buff++) {
			...
			func_block->dma_channel[chan].buffer_start_offset[buff] =
				...
				DM35418_DMA_CTRL_BLOCK_SIZE +
				(DM35418_DMA_BUFFER_CTRL_BLOCK_SIZE * buff);
...
DM35418LIB_API
int DM35418_Function_Block_Open_Module(struct DM35418_Board_Descriptor *handle,
				uint32_t fb_type,
				...
				struct DM35418_Function_Block *func_block)
{
	...
	while (found == 0 && func_block_count < DM35418_MAX_FB) {

		return_code = DM35418_Function_Block_Open(handle,
							func_block_count,
							func_block);
