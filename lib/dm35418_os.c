				...
				uint32_t buffer_size)
{
	...
	DM35418_Check_Result(result, "Error disabling DMA interrupts.");
	...
	DM35418_Check_Result(result, "Error clearing DMA.");
	...
	DM35418_Check_Result(result, "Error clearing DMA interrupts.");
	...
	for (buff = 0; buff < num_buffers; buff++) {
		...
		DM35418_Check_Result(result, "Error initializing DMA via ioctl");
		...
		DM35418_Check_Result(result, "Error setting DMA Buffer size");
		...
		DM35418_Check_Result(result, "Error resetting DMA buffer.");
		...
		DM35418_Check_Result(result, "Error clearing buffer control register.");
