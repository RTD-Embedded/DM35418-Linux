/**
	...
	@brief
		DM35418 ADC library source code

	$Id: librtd-dm35418_adc.c 103507 2016-10-12 20:58:56Z rgroner $
*/
...
/**
 * @defgroup DM35418_ADC_Library_Constants DM35418 ADC library constants
 * @{
 */
 ...
 * ADC Constants
 *****************************************************************************/
#define DM35418_INIT_WAIT_TIME_USEC		10000000
#define DM35418_INIT_SLEEP_USEC		10000
#define DM35418_FECONFIG_SLEEP_USEC		1000

/**
 * @} DM35418_ADC_Library_Constants
 */
 ...
 *****************************************************************************/
/**
 * @defgroup DM35418_ADC_Library_Source DM35418 ADC library source code
 * @{
 */
...
/**
 * @defgroup DM35418_ADC_Library_Private_Functions DM35418 ADC library
...
static int
DM35418_Adc_Validate_Clock(uint8_t clk_src)
{
...
static int
DM35418_Validate_Clock_Global_Source(enum DM35418_Clock_Sources select,
					enum DM35418_Adc_Clock_Events driver)
{


	switch (driver) {
		/* breaks intentionally omitted */
	case DM35418_ADC_CLK_BUS_SRC_DISABLE:
	case DM35418_ADC_CLK_BUS_SRC_SAMPLE_TAKEN:
	case DM35418_ADC_CLK_BUS_SRC_CHAN_THRESH:
	case DM35418_ADC_CLK_BUS_SRC_PRE_START_BUFF_FULL:
	case DM35418_ADC_CLK_BUS_SRC_START_TRIG:
	case DM35418_ADC_CLK_BUS_SRC_STOP_TRIG:
	case DM35418_ADC_CLK_BUS_SRC_POST_STOP_BUFF_FULL:
	case DM35418_ADC_CLK_BUS_SRC_SAMPLING_COMPLETE:
	case DM35418_ADC_CLK_BUS_SRC_PACER_TICK:
		break;
	default:
		errno = EINVAL;
		return -1;
 ...
 */
static int
DM35418_Adc_Validate_Sample(enum DM35418_Input_Ranges input_range,
				int32_t adc_sample)
{

	switch (input_range) {
	case DM35418_ADC_RNG_BIPOLAR_10V:
		/* Breaks intentionally omitted */
	case DM35418_ADC_RNG_BIPOLAR_5V:
	case DM35418_ADC_RNG_BIPOLAR_2_5V:
	case DM35418_ADC_RNG_BIPOLAR_1_25V:
	case DM35418_ADC_RNG_BIPOLAR_625mV:
		if ((adc_sample < DM35418_ADC_BIPOLAR_MIN) ||
		    (adc_sample > DM35418_ADC_BIPOLAR_MAX)) {
			    errno = ERANGE;
			    return -1;
		}
		break;

	case DM35418_ADC_RNG_UNIPOLAR_10V:
		/* Breaks intentionally omitted */
	case DM35418_ADC_RNG_UNIPOLAR_5V:
	case DM35418_ADC_RNG_UNIPOLAR_2_5V:
	case DM35418_ADC_RNG_UNIPOLAR_1_25V:
		if ((adc_sample < DM35418_ADC_UNIPOLAR_MIN) ||
		    (adc_sample > DM35418_ADC_UNIPOLAR_MAX)) {
			errno = ERANGE;
			return -1;
		}
		break;
 ...
 */
static int
DM35418_Adc_Validate_Input_Range(enum DM35418_Input_Ranges rng)
{
 ...
 */
static int
DM35418_Adc_Validate_Input_Mode(enum DM35418_Input_Mode input_mode)
{
	switch(input_mode)
	{
	case DM35418_ADC_INPUT_SINGLE_ENDED:
	case DM35418_ADC_INPUT_DIFFERENTIAL:
	case DM35418_ADC_INPUT_VREF_5V:
		break;
	default:
		errno = EINVAL;
		return -1;
 ...
 */
static int
DM35418_Adc_Validate_Channel_Setup(const struct DM35418_Function_Block *func_block,
					unsigned int channel,
					enum DM35418_Input_Ranges rng,
					enum DM35418_Input_Mode mode) {
	...
	if(DM35418_Adc_Validate_Input_Mode(mode))
	{
		errno = EINVAL;
		return -1;
	}

	if (DM35418_Adc_Validate_Input_Range(rng)) {
		errno = EINVAL;
		return -1;
	}
...
/**
 * @} DM35418_ADC_Library_Private_Functions
 */
...
/**
 * @defgroup DM35418_ADC_Library_Public_Functions DM35418 ADC source
...
DM35418LIB_API
int DM35418_Adc_Get_Start_Trigger(struct DM35418_Board_Descriptor *handle,
				struct DM35418_Function_Block *func_block,
				uint8_t *trigger)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_START_TRIG;
...
DM35418LIB_API
int DM35418_Adc_Set_Start_Trigger(struct DM35418_Board_Descriptor *handle,
				struct DM35418_Function_Block *func_block,
				uint8_t trigger)
{
	...
	if (DM35418_Adc_Validate_Clock(trigger)) {
		return -1;
	}
...
DM35418LIB_API
int DM35418_Adc_Get_Stop_Trigger(struct DM35418_Board_Descriptor *handle,
				struct DM35418_Function_Block *func_block,
				uint8_t *trigger)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_STOP_TRIG;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
...
DM35418LIB_API
int DM35418_Adc_Set_Stop_Trigger(struct DM35418_Board_Descriptor *handle,
				struct DM35418_Function_Block *func_block,
				uint8_t trigger)
{
...
DM35418LIB_API
int DM35418_Adc_Get_Pre_Trigger_Samples(struct DM35418_Board_Descriptor *handle,
					...
					uint32_t *pre_capture_count)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_PRE_CAPT_COUNT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
...
DM35418LIB_API
int DM35418_Adc_Set_Pre_Trigger_Samples(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					uint32_t pre_capture_count)
{
	...
	if (pre_capture_count > DM35418_FIFO_SAMPLE_SIZE) {
		errno = EINVAL;
		return -1;
	}
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_PRE_CAPT_COUNT;
...
DM35418LIB_API
int DM35418_Adc_Get_Post_Stop_Samples(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					uint32_t *post_capture_count)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_POST_CAPT_COUNT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
...
DM35418LIB_API
int DM35418_Adc_Set_Post_Stop_Samples(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					uint32_t post_capture_count)
{
...
DM35418LIB_API
int DM35418_Adc_Get_Clock_Src(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					enum DM35418_Clock_Sources *source)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_CLK_SRC;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
...
DM35418LIB_API
int DM35418_Adc_Set_Clock_Src(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					enum DM35418_Clock_Sources source)
{
	...
	if (DM35418_Adc_Validate_Clock(source)) {
		return -1;
	}
 ...
 */
DM35418LIB_API
int DM35418_Adc_Initialize(struct DM35418_Board_Descriptor *handle,
				const struct DM35418_Function_Block *func_block)
{
	union dm35418_ioctl_argument ioctl_request;
	int return_code = 0;
	 ...
	 */
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_MODE_STATUS;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	...
	if (mode_status != DM35418_ADC_STAT_UNINITIALIZED &&
	    mode_status != DM35418_ADC_STAT_INITIALIZING) {
		return return_code;
	}

	if (mode_status != DM35418_ADC_STAT_INITIALIZING) {
		/*
		 * It is Uninitialized, so tell it to reset
		 */
		ioctl_request.readwrite.access.data.data8 = DM35418_ADC_MODE_RESET;
	...
	max_sleep_counts = DM35418_INIT_WAIT_TIME_USEC / DM35418_INIT_SLEEP_USEC;

	while (mode_status != DM35418_ADC_STAT_STOPPED &&
		(sleep_counts < max_sleep_counts)) {

		// Sleep for 10 msec
		DM35418_Micro_Sleep(DM35418_INIT_SLEEP_USEC);
	...
	if (mode_status != DM35418_ADC_STAT_STOPPED) {
		errno = EBUSY;
		return -1;
	}
	else {
...
DM35418LIB_API
int DM35418_Adc_Set_Clk_Divider(struct DM35418_Board_Descriptor *handle,
				const struct DM35418_Function_Block *func_block,
				uint32_t divider)
{
	union dm35418_ioctl_argument ioctl_request;

	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_CLK_DIV;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Set_Sample_Rate(struct DM35418_Board_Descriptor *handle,
				const struct DM35418_Function_Block *func_block,
				uint32_t rate,
				uint32_t *actual_rate)
{
	...
	*actual_rate = system_clock_rate / (divider * pacer_sample_rate);
	 ...
	 */
	return DM35418_Adc_Set_Clk_Divider(handle,
									func_block,
									divider - 1);
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Get_Front_End_Config(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					unsigned int channel,
					uint16_t *fe_config)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_FRONT_END_CONFIG;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Interrupt_Set_Config(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					...
					int enable)
{
	...
	if (enable) {
		 ...
		 */
		return_code = DM35418_Adc_Interrupt_Clear_Status(handle, func_block,
		    						interrupt_src);
		if (return_code != 0) {
			return return_code;
		}
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_INT_ENABLE;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Interrupt_Get_Config(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
 ...
 */
DM35418LIB_API
int DM35418_Adc_Start(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block)
{
	...
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	ioctl_request.readwrite.access.data.data8 = DM35418_ADC_MODE_GO_SINGLE_SHOT;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Start_Rearm(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block)
{
	...
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	ioctl_request.readwrite.access.data.data8 = DM35418_ADC_MODE_GO_REARM;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Reset(struct DM35418_Board_Descriptor *handle,
		const struct DM35418_Function_Block *func_block)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Pause(struct DM35418_Board_Descriptor *handle,
		const struct DM35418_Function_Block *func_block)
{
	...
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	ioctl_request.readwrite.access.data.data8 = DM35418_ADC_MODE_PAUSE;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Uninitialize(struct DM35418_Board_Descriptor *handle,
		const struct DM35418_Function_Block *func_block)
{
	...
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
	ioctl_request.readwrite.access.data.data8 = DM35418_ADC_MODE_UNINITIALIZED;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Get_Mode_Status(struct DM35418_Board_Descriptor *handle,
		const struct DM35418_Function_Block *func_block,
		uint8_t *mode_status)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Get_Last_Sample(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					unsigned int channel,
					int32_t *value)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_LAST_SAMPLE;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Get_Sample_Count(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						uint32_t *value)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_SAMPLE_COUNT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Interrupt_Get_Status(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						uint16_t *value)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset + DM35418_OFFSET_ADC_INT_STAT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Interrupt_Clear_Status(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						uint16_t value)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Setup(struct DM35418_Board_Descriptor *handle,
				struct DM35418_Function_Block *func_block,
				unsigned int channel,
				enum DM35418_Input_Ranges input_range,
				enum DM35418_Input_Mode input_mode)
{
	...
	if (DM35418_Adc_Validate_Channel_Setup(func_block,
							channel,
							input_range,
							input_mode)) {
		errno = EINVAL;
	...
	switch (input_range) {
	case DM35418_ADC_RNG_BIPOLAR_10V:
		fe_data = DM35418_ADC_FE_CONFIG_BIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_05;
		break;

	case DM35418_ADC_RNG_BIPOLAR_5V:
		fe_data = DM35418_ADC_FE_CONFIG_BIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_1;
		break;
	case DM35418_ADC_RNG_UNIPOLAR_10V:
		fe_data = DM35418_ADC_FE_CONFIG_UNIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_1;
		break;

	case DM35418_ADC_RNG_BIPOLAR_2_5V:
		fe_data = DM35418_ADC_FE_CONFIG_BIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_2;
		break;
	case DM35418_ADC_RNG_UNIPOLAR_5V:
		fe_data = DM35418_ADC_FE_CONFIG_UNIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_2;
		break;

	case DM35418_ADC_RNG_BIPOLAR_1_25V:
		fe_data = DM35418_ADC_FE_CONFIG_BIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_4;
		break;
	case DM35418_ADC_RNG_UNIPOLAR_2_5V:
		fe_data = DM35418_ADC_FE_CONFIG_UNIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_4;
		break;

	case DM35418_ADC_RNG_BIPOLAR_625mV:
		fe_data = DM35418_ADC_FE_CONFIG_BIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_8;
		break;
	case DM35418_ADC_RNG_UNIPOLAR_1_25V:
		fe_data = DM35418_ADC_FE_CONFIG_UNIPOLAR | DM35418_ADC_FE_CONFIG_GAIN_8;
		break;
	...
	fe_config = DM35418_Get_Maskable(fe_data,
						DM35418_ADC_FE_CONFIG_GAIN_MASK 	|
						DM35418_ADC_FE_CONFIG_POLARITY_MASK);


	switch(input_mode)
	{
	    case DM35418_ADC_INPUT_SINGLE_ENDED:
		fe_config |= DM35418_Get_Maskable(
		    DM35418_ADC_FE_CONFIG_SINGLE_ENDED,
		    DM35418_ADC_FE_CONFIG_MODE_MASK);

		break;

	    case DM35418_ADC_INPUT_DIFFERENTIAL:
		fe_config |= DM35418_Get_Maskable(
		    DM35418_ADC_FE_CONFIG_DIFFERENTIAL,
		    DM35418_ADC_FE_CONFIG_MODE_MASK);
	    ...
	    case DM35418_ADC_INPUT_VREF_5V:
		fe_config |= DM35418_Get_Maskable(
		    DM35418_ADC_FE_CONFIG_INPUT_VREF_5V,
		    DM35418_ADC_FE_CONFIG_MODE_MASK);
	...
	return_code = DM35418_Write(handle, &ioctl_request);
		 ...
		 */
		DM35418_Micro_Sleep(DM35418_FECONFIG_SLEEP_USEC);
    	}
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Reset(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						unsigned int channel)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Interrupt_Set_Config(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						unsigned int channel,
						...
						int enable)
{
	...
	if (enable) {
		 ...
		 * get an interrupt from previous data
		 */
		return_code = DM35418_Adc_Channel_Interrupt_Clear_Status(handle,
	...
	ioctl_request.modify.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_INTR_ENABLE;
	ioctl_request.modify.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.modify.access.size = DM35418_PCI_REGION_ACCESS_8;

	ioctl_request.modify.mask.mask8 = interrupt_to_set;
	ioctl_request.modify.access.data.data8 = data_to_write;

	return DM35418_Modify(handle, &ioctl_request);
}
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Interrupt_Get_Config(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						unsigned int channel,
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Interrupt_Get_Status(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						unsigned int channel,
						uint8_t *chan_intr_status)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_INTR_STAT;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Interrupt_Clear_Status(struct DM35418_Board_Descriptor *handle,
						const struct DM35418_Function_Block *func_block,
						unsigned int channel,
						uint8_t chan_intr_status)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Find_Interrupt(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					...
					uint8_t *channel_intr_enable)
{
	...
	*channel_has_interrupt = 0;
	...
	while (*channel_has_interrupt == 0 &&
		...
		return_code = DM35418_Adc_Channel_Interrupt_Get_Status(handle,
									func_block,
									*channel_with_interrupt,
									channel_intr_status);
		if (return_code != 0) {
		...
		if (*channel_intr_status != 0) {
			...
			return_code = DM35418_Adc_Channel_Interrupt_Get_Config(handle,
										func_block,
										*channel_with_interrupt,
										channel_intr_enable);
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Set_Filter(struct DM35418_Board_Descriptor *handle,
				const struct DM35418_Function_Block *func_block,
				unsigned int channel,
				uint8_t chan_filter)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_FILTER;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_8;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Get_Filter(struct DM35418_Board_Descriptor *handle,
				const struct DM35418_Function_Block *func_block,
				unsigned int channel,
				uint8_t *chan_filter)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Set_Low_Threshold(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					unsigned int channel,
					int32_t threshold)
{
	...
	// Determine min and max values for the thresholds
        ...
        // query the function block to determine polarity mode
        return_code = DM35418_Adc_Channel_Get_Front_End_Config(handle,
					func_block, channel, &mode);
        if(return_code != 0) {
            return return_code;
        }

        mode &= DM35418_ADC_FE_CONFIG_POLARITY_MASK;

        if(mode == DM35418_ADC_FE_CONFIG_UNIPOLAR) {
            max = DM35418_ADC_UNIPOLAR_THRESHOLD_MAX;
            min = DM35418_ADC_UNIPOLAR_THRESHOLD_MIN;
        }
        else { // bipolar
            max = DM35418_ADC_BIPOLAR_THRESHOLD_MAX;
            min = DM35418_ADC_BIPOLAR_THRESHOLD_MIN;
        }
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_LOW_THRESHOLD;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Set_High_Threshold(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					unsigned int channel,
					int32_t threshold)
{
	...
	ioctl_request.readwrite.access.offset = func_block->control_offset +
		DM35418_OFFSET_ADC_CHAN_CTRL_BLK_START +
		(channel * DM35418_ADC_CHAN_CTRL_BLK_SIZE) +
		DM35418_OFFSET_ADC_CHAN_HIGH_THRESHOLD;
	ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
	ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
	ioctl_request.readwrite.access.data.data32 = threshold;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Channel_Get_Thresholds(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					unsigned int channel,
...
DM35418LIB_API
int DM35418_Adc_Fifo_Channel_Read(struct DM35418_Board_Descriptor *handle,
                            		const struct DM35418_Function_Block *func_block,
                            		unsigned int channel,
                            		int32_t *value)
{
	...
	ioctl_request.readwrite.access.offset = func_block->fb_offset +
				DM35418_OFFSET_ADC_FIFO_CTRL_BLK_START +
				(channel * DM35418_ADC_FIFO_CTRL_BLK_SIZE);
				ioctl_request.readwrite.access.region = DM35418_PCI_REGION_FB;
				ioctl_request.readwrite.access.size = DM35418_PCI_REGION_ACCESS_32;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Set_Clock_Source_Global(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					enum DM35418_Clock_Sources clock_select,
					enum DM35418_Adc_Clock_Events clock_driver)
{
	...
	return_code = DM35418_Validate_Clock_Global_Source(clock_select,
								clock_driver);
	...
	switch (clock_select) {
	case DM35418_CLK_SRC_BUS2:
		offset = DM35418_OFFSET_ADC_CLK_BUS2;
		break;
	case DM35418_CLK_SRC_BUS3:
		offset = DM35418_OFFSET_ADC_CLK_BUS3;
		break;
	case DM35418_CLK_SRC_BUS4:
		offset = DM35418_OFFSET_ADC_CLK_BUS4;
		break;
	case DM35418_CLK_SRC_BUS5:
		offset = DM35418_OFFSET_ADC_CLK_BUS5;
		break;
	case DM35418_CLK_SRC_BUS6:
		offset = DM35418_OFFSET_ADC_CLK_BUS6;
		break;
	case DM35418_CLK_SRC_BUS7:
		offset = DM35418_OFFSET_ADC_CLK_BUS7;
		break;
	default:
		errno = EINVAL;
		return -1;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Get_Clock_Source_Global(struct DM35418_Board_Descriptor *handle,
					const struct DM35418_Function_Block *func_block,
					int clock_select,
					int *clock_source)
{
 ...
 */
DM35418LIB_API
int DM35418_Adc_Sample_To_Volts(enum DM35418_Input_Ranges input_range,
					int32_t adc_sample,
					float *volts)
{
	...
	if (DM35418_Adc_Validate_Sample(input_range,
					adc_sample))
	{
		errno = EINVAL;
		return -1;
	...
	switch (input_range) {
	case DM35418_ADC_RNG_BIPOLAR_10V:
		lsb = DM35418_ADC_RNG_20_LSB;
		break;
	case DM35418_ADC_RNG_BIPOLAR_5V:
	case DM35418_ADC_RNG_UNIPOLAR_10V:
		lsb = DM35418_ADC_RNG_10_LSB;
		break;
	case DM35418_ADC_RNG_BIPOLAR_2_5V:
	case DM35418_ADC_RNG_UNIPOLAR_5V:
		lsb = DM35418_ADC_RNG_5_LSB;
		break;
	case DM35418_ADC_RNG_BIPOLAR_1_25V:
	case DM35418_ADC_RNG_UNIPOLAR_2_5V:
		lsb = DM35418_ADC_RNG_2_5_LSB;
		break;
	case DM35418_ADC_RNG_BIPOLAR_625mV:
	case DM35418_ADC_RNG_UNIPOLAR_1_25V:
		lsb = DM35418_ADC_RNG_1_25_LSB;
		break;
	default:
		errno = EINVAL;
		return -1;
 ...
 */
DM35418LIB_API
int DM35418_Adc_Volts_To_Sample(
                enum DM35418_Input_Ranges input_range,
				float volts,
				int32_t *adc_sample)
{
...
/**
 * @} DM35418_ADC_Library_Public_Functions
 */

/**
 * @} DM35418_ADC_Library_Source
 */
