/**
    ...
    $Id: dm35418_temperature.c 141531 2024-03-06 21:05:25Z lfrankenfield $
...
#include "dm35418_temperature_library.h"
...
int main(int argument_count, char **arguments)
{
	...
	result = DM35418_Temperature_Open(board, 0, &temp_fb);

	DM35418_Check_Result(result, "Could not open temperature function block.");
	printf("success.\n");
	...
	while (!exit_program) {
		result = DM35418_Temperature_Read(board, &temp_fb,
						  &temperature);
		DM35418_Check_Result(result, "Could not read temperature");
		...
		fprintf(stdout, "   %3.2f\t   %3.2f\t   %3.2f   \r",
			temperature, min_temp, max_temp);
		fflush(stdout);
		DM35418_Micro_Sleep(500000);
	}
