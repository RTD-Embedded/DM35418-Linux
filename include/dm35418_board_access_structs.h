/**
    ...
    $Id: dm35418_board_access_structs.h 80523 2014-07-17 18:38:59Z rgroner $
*/
...
#ifndef _DM35418_BOARD_ACCESS_STRUCTS__H_
#define _DM35418_BOARD_ACCESS_STRUCTS__H_


/**
 * @defgroup DM35418_PCI_Region_Structures DM35418 PCI Region Structures
 * @{
 */
...
enum dm35418_pci_region_access_size {

	/**
	 * 8-bit access
	 */

	DM35418_PCI_REGION_ACCESS_8 = 0,

	/**
	 * 16-bit access
	 */

	DM35418_PCI_REGION_ACCESS_16,

	/**
	 * 32-bit access
	 */

	DM35418_PCI_REGION_ACCESS_32,
 ...
 */
enum DM35418_DMA_FUNCTIONS {

	/**
	 * Initialize the DMA buffers
	 */
	DM35418_DMA_INITIALIZE,
...
struct dm35418_pci_access_request {

	/**
	 * Size of access in bits
	 */

	enum dm35418_pci_region_access_size size;

	/**
	 * The PCI region to access
	 */

	enum dm35418_pci_region_num region;
...
struct dm35418_ioctl_region_readwrite {

	/**
	 * PCI region access request
	 */

	struct dm35418_pci_access_request access;
};
...
struct dm35418_ioctl_region_modify {
...
struct dm35418_ioctl_interrupt_info_request {
 ...
 */
struct dm35418_ioctl_dma {

	/**
	 * Requested DMA function to perform.
	 */
	enum DM35418_DMA_FUNCTIONS function;
	 ...
	 */
	struct dm35418_pci_access_request pci;
...
union dm35418_ioctl_argument {
	...
	struct dm35418_ioctl_region_readwrite readwrite;

	/**
	 * PCI region read/modify/write
	 */

	struct dm35418_ioctl_region_modify modify;

	/**
	 * Interrupt request structure
	 */

	struct dm35418_ioctl_interrupt_info_request interrupt;
	/**
