/**
    ...
    @brief
        Defines for the DM35418 Example programs.  Commonly used constants
        for the example programs included with the software package.


    $Id: dm35418_examples.h 114740 2018-07-12 14:41:17Z prucz $
*/
...
#ifndef __DM35418_EXAMPLES_H__
#define __DM35418_EXAMPLES_H__

 /**
  * @defgroup DM35418_Example_Constants DM35418 Example Programs Constants
  * @{
  */
